...
reports/output/academic-plan-diffs.json: files/metrics_fa12.csv diff_plan.py files/academic_plans_fa12.csv files/isis_major_code_list.xlsx\ -\ Major\ Codes.csv
	python3 diff_plan.py

reports/output/academic-plan-diffs.html: reports/output/academic-plan-diffs.json plan-diffs-template.html plan-diffs.tsx
	head -n -2 < plan-diffs-template.html > reports/output/academic-plan-diffs.html
	...
	deno bundle plan-diffs.tsx >> reports/output/academic-plan-diffs.html
...
reports/output/prereq-diffs.html:
...
reports/output/prereq-timeline.html:
...
reports/output/college-ge-units.html:
